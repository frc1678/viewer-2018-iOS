...
@objc class Utils: NSObject {
    ...
    static let humanReadableNames = [
        ...
        "calculatedData.switchFailPercentageTele" : "Tele SW Fail Percentage",
        "calculatedData.scaleFailPercentageTele" : "Tele SC Fail Percentage",
        "calculatedData.canScoreBothSwitchSidesAuto" : "Auto Multi-Side",
        "didMakeAutoRun" : "Did Make Auto Run",
        "calculatedData.switchFailPercentageAuto" : "Auto SW Fail Percentage",
        "calculatedData.scaleFailPercentageAuto" : "Auto SC Fail Percentage",
